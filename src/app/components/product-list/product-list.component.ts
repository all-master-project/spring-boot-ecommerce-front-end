...
export class ProductListComponent implements OnInit {
  ...
  //when class instanciated call first ngOnInint()
  ...
  handleListProducts() {
    ...
    if (hasCategoryId) {
      //get the id param strong .convert string to number using the "+" symbole
    ...
    //now get the product for the given category
    this.productService
